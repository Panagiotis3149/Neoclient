...
public class Animations extends Module {
    ...
    public static final ButtonSetting clientSide = new ButtonSetting("Client side (visual 1.7)", true);
    private final SliderSetting blockAnimation = new SliderSetting("Block animation", new String[]{"None", "1.7", "Smooth", "Exhibition", "Stab", "Spin", "Sigma", "Wood", "Swong", "Chill", "Komorebi", "Rhys", "Allah"}, 1);
    private final SliderSetting swingAnimation = new SliderSetting("Swing animation", new String[]{"None", "1.9+", "Smooth", "Punch", "Shove"}, 0);
    private final SliderSetting otherAnimation = new SliderSetting("Other animation", new String[]{"None", "1.7"}, 1);
    ...
    public Animations() {
        ...
        this.registerSetting(blockAnimation);
        this.registerSetting(swingAnimation);
        this.registerSetting(otherAnimation);
        this.registerSetting(swingWhileDigging);
        this.registerSetting(clientSide);
        this.registerSetting(fakeSlotReset);
        this.registerSetting(x);
        this.registerSetting(y);
        this.registerSetting(z);
        this.registerSetting(swingSpeed);
        this.registerSetting(swingSpeedWhileBlocking);

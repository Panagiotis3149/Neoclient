...
public class TargetHUD extends Module {
    ...
    public void select(Timer cd, String string, double health, String name) {
        if ((int) mode.getInput() == 0) {
            ...
            int height = 40;
            BlurUtils.prepareBlur();
            RoundedUtils.drawRound((float) x5, (float) y5, width, height, 4.0f, true, RenderUtils.toColor(RenderUtils.toArgb(RenderUtils.toRgbColor(Theme.getGradient(theme.getInput(), 0)), 255)));

...
public class Utils {
    ...
    public static void setMotions(double n) {
    ...
    public static void oldncpSelfDamage() {
        ...
        mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX, mc.thePlayer.posX, mc.thePlayer.posZ, true));
    ...
    public static void karhuSelfDamage() {

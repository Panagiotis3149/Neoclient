...
public class BHop extends Module {
    ...
    public BHop() {
        super("Speed", category.movement, 44);
        ...
        switch ((int) mode.getInput()) {
            ...
            case 1:
                if (!Utils.jumpDown() && Utils.isMoving() && mc.currentScreen == null) {
                    ...
                    if (autoJump.isToggled()) mc.thePlayer.jump(); else if (!Keyboard.isKeyDown(mc.gameSettings.keyBindJump.getKeyCode()) && !autoJump.isToggled()) return;
                    mc.thePlayer.setSprinting(true);
                    ...
                    switch (speedAmplifier) {
                        case 1: speedModifier = 0.5252; break;
                        case 2: speedModifier = 0.587; break;
                        case 3: speedModifier = 0.6289; break;
                    }
                    double additionalSpeed = speedModifier * ((speed.getInput() - 1.0) / 3.0 + 1.0);
                    if (horizontalSpeed < additionalSpeed) horizontalSpeed = additionalSpeed;
            ...
            case 2:
                ...
                if (MoveUtil.isMoving()) {
                    ...
                    if (offGroundTicks == 4 || offGroundTicks == 7) mc.thePlayer.motionY *= 1.005F;
                }
                hopping = true;
                break;
            case 3:
                ...
                if (!Utils.jumpDown() && Utils.isMoving() && mc.currentScreen == null) {
                    ...
                    if (mc.thePlayer.onGround) {
                        ...
                        if (lastAngle != 999 && Math.abs(lastAngle - angle) > 20 && ticksSinceVelocity > 20) {
                            ...
                            switch (speed) {
                                case 0: MoveUtil.moveFlying(-0.005); break;
                                case 1: MoveUtil.moveFlying(-0.035); break;
                                default: MoveUtil.moveFlying(-0.04); break;
                            }
                        }
                        lastAngle = angle;
                    }
            ...
            case 6:
                ...
                if (Utils.isMoving() && mc.thePlayer.onGround && autoJump.isToggled()) mc.thePlayer.jump();
                MoveUtil.strafea();
                break;
            case 7:
                Utils.resetTimer();
    ...
    public void onTick(TickEvent e) {
        switch ((int) mode.getInput()) {
            case 5: VulcanSpeed.onTick(e); break;
            case -1: break; // so intellij doesn't complain about warnings...
        }
    }
    ...
    public void onStrafe(StrafeEvent e) {
        switch ((int) mode.getInput()) {
            case 13: MatrixSpeed.MatrixSpeed(e); break;
            case 5: VulcanSpeed.VulcanSpeed(e); break;
        }
    }

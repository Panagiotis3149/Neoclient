...
public class TargetESP extends Module {
    ...
    private final String[] modes = new String[]{"Ring", "Vape", "Raven", "Both", "Ghost", "Ring2"};
    ...
    public void renderSigma2(@NotNull EntityLivingBase target) {
        Color colori = Color.WHITE;
        int drawTime = (int) (System.currentTimeMillis() % 1850);
        boolean drawMode = drawTime > 850;
        float drawPercent = drawTime / 850f;
        ...
        for (int segments = 0; segments < 360; segments += 5) {
            ...
            GL11.glBegin(GL11.GL_QUADS);
            GL11.glColor4f(colori.getRed() / 255.0f, colori.getGreen() / 255.0f, colori.getBlue() / 255.0f, 0.0f);
            GL11.glVertex3d(x1, y + eased, z1);
            GL11.glVertex3d(x2, y + eased, z2);
            GL11.glColor4f(colori.getRed() / 255.0f, colori.getGreen() / 255.0f, colori.getBlue() / 255.0f, colori.getAlpha() / 255.0f);
            GL11.glVertex3d(x2, y, z2);
            GL11.glVertex3d(x1, y, z1);
            GL11.glEnd();
            GL11.glBegin(GL11.GL_LINE_LOOP);

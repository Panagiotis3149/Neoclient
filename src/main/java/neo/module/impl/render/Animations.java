...
import neo.event.*;
import neo.mixins.impl.render.ItemRendererAccessor;
...
public class Animations extends Module {
    ...
    public void onSendPacket(SendPacketEvent event) {
        if (Utils.isntnull() && swingWhileDigging.isToggled() && clientSide.isToggled() && SendPacketEvent.getPacket() instanceof C0APacketAnimation && mc.thePlayer.isUsingItem()) {
